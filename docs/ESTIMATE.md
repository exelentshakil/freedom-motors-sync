...
**Calibrated Rate**: $50.00/hr  
**Total Scoped Hours**: 70 Hours  
**Total Turnkey Investment**: $3,500.00 USD  
...
*Estimated Hours: 16 hrs | Rate: $50.00/hr | Subtotal: $800.00*
...
*Estimated Hours: 18 hrs | Rate: $50.00/hr | Subtotal: $900.00*
...
*Estimated Hours: 10 hrs | Rate: $50.00/hr | Subtotal: $500.00*
- Implement Google Tag Manager container with structured `window.dataLayer` event dispatching (`ada_fit_calculated`, `view_item`, `lead_submission`).
...
*Estimated Hours: 8 hrs | Rate: $50.00/hr | Subtotal: $400.00*
...
| **Phase 1** | Sanity Studio Schema & Fieldset Locks | 16 hrs | **$800.00** |
| **Phase 2** | Daily FTPS Ingestion Daemon & Watchdog | 18 hrs | **$900.00** |
| **Phase 3** | Next.js 15 App Router & Sub-50ms On-Demand ISR | 18 hrs | **$900.00** |
| **Phase 4** | Third-Party Telemetry (GTM, Meta CAPI, HubSpot) | 10 hrs | **$500.00** |
| **Phase 5** | 3-Tier Environment Isolation & Production Cutover | 8 hrs | **$400.00** |
| **TOTAL** | **Full Turnkey Migration & Ingestion Platform** | **70 hrs** | **$3,500.00** |
